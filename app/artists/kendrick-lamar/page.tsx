...
export default function KendrickLamarPage() {
  return (
    <ComingSoonArtist
      ...
      artistImage="https://images.unsplash.com/photo-1668626317130-02228b116fd9?w=800&auto=format&fit=crop&q=60"
      ...
      accentColor="from-orange-400 via-red-400 to-yellow-400"
    />
  );
}